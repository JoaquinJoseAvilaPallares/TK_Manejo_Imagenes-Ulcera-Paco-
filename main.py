...
class Paco(tk.Tk):
    ...
    def __init__(self):
        ...
        self.imagenes_ulcera = os.listdir("C://Users//Joaquin Avila//Documents//Proyectos//TK_Manejo_Imagenes(Ulcera-Paco)//Paco_Ulcera//Fotos_Ulcera")
    ...
    def creacion_componenetes(self):
        ...
        for dia in range(len(self.imagenes_pie_derecho_am)):
            self.imagenes_am['imagen'+str(dia+1)] = PhotoImage(file=f'C://Users//Joaquin Avila//Documents//Proyectos//TK_Manejo_Imagenes(Ulcera-Paco)//Paco_Ulcera//Fotos_Ulcera//{self.imagenes_pie_derecho_am[dia]}').subsample(7)
        ...
        for dia in range(len(self.imagenes_pie_derecho_pm)):
            self.imagenes_pm['imagen' + str(dia + 1)] = PhotoImage(file=f'C://Users//Joaquin Avila//Documents//Proyectos//TK_Manejo_Imagenes(Ulcera-Paco)//Paco_Ulcera//Fotos_Ulcera//{self.imagenes_pie_derecho_pm[dia]}').subsample(7)
